package com.moto.service.moto_service.Controller;

import com.moto.service.moto_service.entities.Moto;
import com.moto.service.moto_service.service.MotoService;
...
public class MotoController {
    ...
    public ResponseEntity<Moto>guardarMoto(@RequestBody Moto moto){
        Moto motoAGuardar = motoService.save(moto);
        return ResponseEntity.ok(motoAGuardar);
    }
